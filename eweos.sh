...
#
##DO NOT RUN DIRECTLY
##Self: bash <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge-dev/runimage-base/refs/heads/main/eweos.sh")
# HOST: x86_64-Linux
#-------------------------------------------------------#
...
##RunImage
 ...
 [[ -s "./runimage" ]] || exit 1
##Get Rootfs
 "./runimage" getdimg --extract rootfs "pkgforge/eweos-base:$(uname -m)"
 RIM_NO_NET="0"
